...
class RidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ride" do
    assert_difference('Ride.count') do
      post rides_url, params: { ride: { metrocard_id: @ride.metrocard_id, station: @ride.station, time: @ride.time } }
    end
  ...
  test "should update ride" do
    patch ride_url(@ride), params: { ride: { metrocard_id: @ride.metrocard_id, station: @ride.station, time: @ride.time } }
