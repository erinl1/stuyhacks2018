...
class SwipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create swipe" do
    assert_difference('Swipe.count') do
      post swipes_url, params: { swipe: { studentcard_id: @swipe.studentcard_id, time: @swipe.time } }
    end
  ...
  test "should update swipe" do
    patch swipe_url(@swipe), params: { swipe: { studentcard_id: @swipe.studentcard_id, time: @swipe.time } }
